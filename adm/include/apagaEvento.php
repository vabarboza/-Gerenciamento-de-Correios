...
$apaga = mysqli_query($conn, "DELETE FROM tbl_eventos WHERE id = $id_arquivo");

if (mysqli_affected_rows($conn) != 0) {
    $_SESSION['apagaEventoOK'] = "Apagar OK";
    header("Location: /adm/pages/eventos/lista.php");
} else {
    $_SESSION['apagaEventoErro'] = "Apagar Erro";
    header("Location: /adm/pages/eventos/lista.php");
}
/*
