...
<div class="container bg-branco p-3 bordered rounded">
  ...
  <form class="needs-validation" enctype="multipart/form-data" action="include/cadInfo.php" method="POST" novalidate>
    <div class="form-row">

      <div class="col-md-8 mb-3">
        <label for="validationCustom01">Nome do Informativo</label>
        <input type="text" class="form-control" name="nome" required>
        <small class="form-text text-muted">Exemplo: Aviso de falta de energia!</small>
    ...
    <div class="form-row">
      <div class="col-md-12 mb-3">
        <label for="exampleFormControlTextarea3">Texto sobre o Informativo</label>
        <textarea class="form-control" id="exampleFormControlTextarea3" rows="4" name="texto" required></textarea>
        <small class="form-text text-muted">O conteudo do Informativo.</small>
        <div class="invalid-feedback">
  ...
  if (isset($_SESSION['cadErro'])) {
    ...
    echo $result;
    unset($_SESSION['cadInfoErro']);
  }
  ?>
  <?php
  //Recuperando o valor da variável global, deslogado com sucesso.
  if (isset($_SESSION['cadInfoOK'])) {
