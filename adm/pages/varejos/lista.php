    ...
    <tbody>
      <?php while ($dado = $result->fetch_array()) { ?>
        <tr>
          ...
          <td>
            <button type="button" class="btn btn-red btn-sm m-0 btn-redondo" data-href="include/apagaVarejo.php?id=<?php echo $dado['id']; ?>" data-toggle="modal" data-target="#confirm-delete">
