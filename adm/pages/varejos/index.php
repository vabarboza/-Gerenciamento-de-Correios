...
<div class="container bg-branco p-3 bordered rounded">
  ...
  <form class="needs-validation" enctype="multipart/form-data" action="include/cadVarejo.php" method="POST" novalidate>
    <div class="form-row">

      <div class="col-md-8 mb-3">
        <label for="validationCustom01">Nome do Varejista</label>
    ...
    <div class="form-row">
      <div class="col-md-12 mb-3">
        <label for="exampleFormControlTextarea3">Texto sobre o Varejista</label>
    ...
    <div class="form-group">
      <div class="form-check">
        ...
        <label class="form-check-label" for="invalidCheck">
          Confirmar cadastro de Varejista
        </label>
        <div class="invalid-feedback">
